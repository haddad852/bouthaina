...
CREATE TABLE `chequier` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `from` FOREIGN KEY (`id`) REFERENCES `compte` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `to` FOREIGN KEY (`id`) REFERENCES `compte` (`id`)
...
INSERT INTO `chequier` VALUES (1,NULL,'8',NULL,NULL,'2021-11-18 16:40:23.104','0'),(2,'3','10',NULL,NULL,'2021-11-18 16:43:17.455','0'),(3,'4','12',NULL,NULL,'2021-11-18 16:43:24.018','0');
...
-- Dump completed on 2021-11-18 16:45:23
